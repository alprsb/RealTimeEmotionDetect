...
def start_camera():
    ...
    while True:
        ...
        for (x, y, w, h) in faces_detected:
            ...
            emotions = ('kizgin', 'ıgrenmış', 'korkmus', 'mutlu', 'uzgun', 'normal', 'dogal')
...
# Ses düğmesini kapatma
stop_button = tk.Button(button_frame, text="Sesli Mesajı Dinle", command=stop_camera)
